...
- 已支持验收记录草稿生成：`pnpm --filter @readany/cli acceptance:scaffold -- --evidence <evidence.json> --output <record.md>` 会把真实 evidence 中的 SHA、citation、doctor distribution 和人工补证项写入 partial 记录草稿，减少手工填表漏锚点。
